...
DECLARE
    ...
    ----pra cada empregado, quantos serviços ele fez...
...
--------------------------------------------------------------------------------
    ...
    ----pra cada empregado, em quantos avioes diferentes ele trabalhou...
    ...
    INDEX BY BINARY_INTERGER;--18

    v_emp_avi_dist Tipo_emp_avi_dist;
-----------------------------------------------------------------------------------
    CURSOR c_empregado IS
    ----pega o nome de cada empregado...
...
----------------------------------------------------------------------------------
    ...
    TYPE Tipo_emp_media IS RECORD(
        empregado Empregado.cpfpes%TYPE,
        media number
    );
